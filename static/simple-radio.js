                ...
                <div style="margin-bottom: 15px;">
                    ...
                    <div id="stations-list" style="max-height: 200px; overflow-y: auto;">
                        <div id="pop-stations" class="station-group">
                            <div onclick="playStation('https://edge-bauerall-01-gos2.sharp-stream.com/net2national.mp3', 'Heart FM')" style="display: flex; align-items: center; padding: 10px; background: rgba(255, 255, 255, 0.1); border-radius: 8px; cursor: pointer; margin-bottom: 5px; transition: all 0.3s ease;"><span style="margin-right: 10px;">❤️</span><span>Heart FM</span></div>
                            ...
                            <div onclick="playStation('https://listen.181fm.com/181-power_128k.mp3', 'Hit Music Only')" style="display: flex; align-items: center; padding: 10px; background: rgba(255, 255, 255, 0.1); border-radius: 8px; cursor: pointer; margin-bottom: 5px; transition: all 0.3s ease;"><span style="margin-right: 10px;">🎵</span><span>Hit Music Only</span></div>
                            <div onclick="playStation('https://listen.181fm.com/181-hits_128k.mp3', 'Today Hits')" style="display: flex; align-items: center; padding: 10px; background: rgba(255, 255, 255, 0.1); border-radius: 8px; cursor: pointer; margin-bottom: 5px; transition: all 0.3s ease;"><span style="margin-right: 10px;">💫</span><span>Today Hits</span></div>
                        ...
                        <div id="electronic-stations" class="station-group" style="display: none;">
                            ...
                            <div onclick="playStation('https://ice1.somafm.com/groovesalad-128-mp3', 'SomaFM Groove Salad')" style="display: flex; align-items: center; padding: 10px; background: rgba(255, 255, 255, 0.1); border-radius: 8px; cursor: pointer; margin-bottom: 5px;"><span style="margin-right: 10px;">🥗</span><span>SomaFM Groove Salad</span></div>
                            <div onclick="playStation('https://ice1.somafm.com/beatblender-128-mp3', 'SomaFM Beat Blender')" style="display: flex; align-items: center; padding: 10px; background: rgba(255, 255, 255, 0.1); border-radius: 8px; cursor: pointer; margin-bottom: 5px;"><span style="margin-right: 10px;">🎛️</span><span>SomaFM Beat Blender</span></div>
                            <div onclick="playStation('https://ice1.somafm.com/dronezone-128-mp3', 'SomaFM Drone Zone')" style="display: flex; align-items: center; padding: 10px; background: rgba(255, 255, 255, 0.1); border-radius: 8px; cursor: pointer; margin-bottom: 5px;"><span style="margin-right: 10px;">🌌</span><span>SomaFM Drone Zone</span></div>
                            <div onclick="playStation('https://ice1.somafm.com/deepspaceone-128-mp3', 'SomaFM Deep Space')" style="display: flex; align-items: center; padding: 10px; background: rgba(255, 255, 255, 0.1); border-radius: 8px; cursor: pointer; margin-bottom: 5px;"><span style="margin-right: 10px;">🚀</span><span>SomaFM Deep Space</span></div>
                            <div onclick="playStation('https://ice1.somafm.com/digitalis-128-mp3', 'SomaFM Digitalis')" style="display: flex; align-items: center; padding: 10px; background: rgba(255, 255, 255, 0.1); border-radius: 8px; cursor: pointer; margin-bottom: 5px;"><span style="margin-right: 10px;">💊</span><span>SomaFM Digitalis</span></div>
                        ...
                        <div id="jazz-stations" class="station-group" style="display: none;">
                            <div onclick="playStation('https://ice1.somafm.com/jazzgroove-128-mp3', 'SomaFM Jazz Groove')" style="display: flex; align-items: center; padding: 10px; background: rgba(255, 255, 255, 0.1); border-radius: 8px; cursor: pointer; margin-bottom: 5px;"><span style="margin-right: 10px;">🎷</span><span>SomaFM Jazz Groove</span></div>
                            <div onclick="playStation('https://ice1.somafm.com/sonicuniverse-128-mp3', 'SomaFM Sonic Universe')" style="display: flex; align-items: center; padding: 10px; background: rgba(255, 255, 255, 0.1); border-radius: 8px; cursor: pointer; margin-bottom: 5px;"><span style="margin-right: 10px;">🌌</span><span>SomaFM Sonic Universe</span></div>
                            <div onclick="playStation('https://ice1.somafm.com/folkfwd-128-mp3', 'SomaFM Folk Forward')" style="display: flex; align-items: center; padding: 10px; background: rgba(255, 255, 255, 0.1); border-radius: 8px; cursor: pointer; margin-bottom: 5px;"><span style="margin-right: 10px;">🎻</span><span>SomaFM Folk Forward</span></div>
                            <div onclick="playStation('https://ice1.somafm.com/seventies-128-mp3', 'SomaFM Seven Inch Soul')" style="display: flex; align-items: center; padding: 10px; background: rgba(255, 255, 255, 0.1); border-radius: 8px; cursor: pointer; margin-bottom: 5px;"><span style="margin-right: 10px;">💿</span><span>SomaFM Seven Inch Soul</span></div>
                            <div onclick="playStation('https://ice1.somafm.com/bluesrock-128-mp3', 'SomaFM Blues Rock')" style="display: flex; align-items: center; padding: 10px; background: rgba(255, 255, 255, 0.1); border-radius: 8px; cursor: pointer; margin-bottom: 5px;"><span style="margin-right: 10px;">🎸</span><span>SomaFM Blues Rock</span></div>
                            <div onclick="playStation('https://ice1.somafm.com/fluid-128-mp3', 'SomaFM Fluid')" style="display: flex; align-items: center; padding: 10px; background: rgba(255, 255, 255, 0.1); border-radius: 8px; cursor: pointer; margin-bottom: 5px;"><span style="margin-right: 10px;">🌊</span><span>SomaFM Fluid</span></div>
                            <div onclick="playStation('https://ice1.somafm.com/sf1033-128-mp3', 'SomaFM SF 10-33')" style="display: flex; align-items: center; padding: 10px; background: rgba(255, 255, 255, 0.1); border-radius: 8px; cursor: pointer; margin-bottom: 5px;"><span style="margin-right: 10px;">🚔</span><span>SomaFM SF 10-33</span></div>
                            <div onclick="playStation('https://ice1.somafm.com/secretagent-128-mp3', 'SomaFM Secret Agent')" style="display: flex; align-items: center; padding: 10px; background: rgba(255, 255, 255, 0.1); border-radius: 8px; cursor: pointer; margin-bottom: 5px;"><span style="margin-right: 10px;">🕵️</span><span>SomaFM Secret Agent</span></div>
                        </div>
                        ...
                        <div id="classical-stations" class="station-group" style="display: none;">
                            ...
                            <div onclick="playStation('https://listen.181fm.com/181-classical_128k.mp3', '181 Classical')" style="display: flex; align-items: center; padding: 10px; background: rgba(255, 255, 255, 0.1); border-radius: 8px; cursor: pointer; margin-bottom: 5px;"><span style="margin-right: 10px;">🎹</span><span>181 Classical</span></div>
                            <div onclick="playStation('https://stream.rcast.net/252741', 'Orchestra Radio')" style="display: flex; align-items: center; padding: 10px; background: rgba(255, 255, 255, 0.1); border-radius: 8px; cursor: pointer; margin-bottom: 5px;"><span style="margin-right: 10px;">🎺</span><span>Orchestra Radio</span></div>
                            <div onclick="playStation('https://stream.rcast.net/253892', 'Symphony Hall')" style="display: flex; align-items: center; padding: 10px; background: rgba(255, 255, 255, 0.1); border-radius: 8px; cursor: pointer; margin-bottom: 5px;"><span style="margin-right: 10px;">🏛️</span><span>Symphony Hall</span></div>
                            <div onclick="playStation('https://stream.rcast.net/252047', 'Baroque Music')" style="display: flex; align-items: center; padding: 10px; background: rgba(255, 255, 255, 0.1); border-radius: 8px; cursor: pointer; margin-bottom: 5px;"><span style="margin-right: 10px;">👑</span><span>Baroque Music</span></div>
                        </div>
                    </div>
                </div>
            </div>
